...
<body>
<div id="login-window">
	<form id="loginForm" action="${basePath}/xitech/index" method="post">
   ...
   <!--  <a id="login-bt" href="javascript:;" class="waves-effect waves-button waves-float"><i class="zmdi zmdi-arrow-forward"></i></a> -->
    <input type="submit" id="login-bt" class="waves-effect waves-button waves-float"><i class="zmdi zmdi-arrow-forward"></i></input>
    </form>
</div>
...
alert('您已被强制下线！');
top.location.href = '${basePath}/xitech/login';
</c:if>
